...
## Tools I am familiar with
  ...
  - [Jira](https://www.atlassian.com/software/jira0), [Confluence](https://www.atlassian.com/software/confluence), [Bitbucket](https://bitbucket.org/), [Trello](https://trello.com/), [Slack](https://slack.com/) - Issue tracking and project management tools for developers.
  - [Visual Studio Code](https://code.visualstudio.com/) - An open-source (and free) IDE created by Microsoft.
...
* Project of my own automatic tests - realized in Selenium Webdriver + Python technology [Link to repo](https://github.com/patt204/DareIT_automatic_tests_challenge) and in Robot framework [Link to repo](https://github.com/patt204/panelscout_robotframework). Prepared test cases: [Link to Google Drive](https://drive.google.com/drive/folders/14qhOWXsOnVeauCRE8GYN1N06fwAkKD2P). Bugs reported for website: [Link to Google Drive](https://drive.google.com/drive/u/0/folders/1pQUUAVHpY0rcYDREGrydV5RY_3i2_r16)
...
My repository: https://github.com/patt204/DareIT_automatic_tests_challenge
...
My repository: https://github.com/patt204/cloud_challenge and https://github.com/patt204/dareit-terraform
